...
Route::group(['prefix'=>'admin', 'middleware' => ['auth', 'revalidate'] ], function(){
	...
	//Damage product route
	Route::model('damage', 'App\Damage');
	Route::get('damaged-products', 'DamageController@getDamageList')->name('damage.index');
	Route::get('damaged-products/add', 'DamageController@addDamageItem')->name('damage.new');
	Route::post('damaged-products/add', 'DamageController@postDamageItem')->name('damage.post');
  ...
  Route::post('purchase/delete','PurchaseController@deletePurchase')->name('purchase.delete');
	...
	Route::get('return/sell', 'ReturnSellController@getReturnSell')->name('return.sell');
	Route::get('return/search/invoice/{invoice_no}', 'ReturnSellController@searchInvoice')->name('search.invoice');
	Route::post('return/new', 'ReturnSellController@postReturnSell')->name('return.post');
	...
	=========================================================*/
	Route::model('expense-category', 'App\ExpenseCategory');
	Route::get('expense-category', 'ExpenseCategoryController@getIndex')->name('expense.category.index');
	Route::post('expense-category', 'ExpenseCategoryController@postIndex')->name('expense.category.post')->middleware('permission:expense.create');
	Route::post('expense-category/edit', 'ExpenseCategoryController@editExpenseCategory')->name('expense.category.edit');
	Route::post('expense-category/delete', 'ExpenseCategoryController@deleteExpenseCategory')->name('expense.category.delete');
	...
	Route::post('report/due-report', 'ReportingController@postDueReport')->name('report.due');
...
Route::post('refreshpos', 'SettingsController@postRefresh');
