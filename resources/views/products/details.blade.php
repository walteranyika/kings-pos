        ...
        <div class="col-md-8">
          <div class="nav-tabs-custom">
            ...
            <table class="table table-bordered">
              ...
              <tr>
                <td class="text-center">{{trans('core.total_damage')}} (-)</td>
                <td class="text-center">{{$product->damages->sum('quantity')}} {{$product->unit}}</td>
              </tr>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="@if(($product->purchases->sum('quantity') + $product->opening_stock) - $product->quantity -  $product->sells->sum('quantity') - $product->damages->sum('quantity') == 0) Ok  @else Not Ok @endif" disabled="true"> 
            </div>
              </div><!-- /.tab-pane -->
            ...
            <div class="tab-pane" id="timeline{{$product->id}}">
              ...
              <!-- Damage Tab Starts-->
              <div class="tab-pane" id="damage{{$product->id}}">
                @if($product->damages->count() == 0)
                    No damaged history for this product 
                @else
                  <table class="table table-bordered">
                    <tr class="bg-khaki">
                        <td class="text-center">{{trans('core.date')}}</td>
                      ...
                      @foreach($product->damages as $damage)
                        <tr>
                          <td class="text-center">{{carbonDate($damage->date, 'h:i:s')}}</td>
                          <td class="text-center">{{$damage->quantity}}</td>
                          <td class="text-center">{{$damage->note}}</td>
                        </tr>
                      @endforeach
                  </table>
                @endif
